...
// It displays tabs for active, draft, and inactive datasets, fetches the list of published datasets,
// and provides links to create new datasets and access guidance resources.
'use client';
