...
class TestAVLListView:
    ...
    def test_services_requiring_attention(self, client_factory, sample_data):
        ...
        BODSLicenceFactory(organisation=organisation, number=licence_number)
        dataset1 = DatasetFactory(organisation=organisation)
        # add NOC to all TXC
        TXCFileAttributesFactory(
        ...
        dataset2 = DraftDatasetFactory(organisation=organisation)
        TXCFileAttributesFactory(
