...
class TestDisruptionsDataView:
    ...
    org_data = [{"id":50,"nocCode":"A2BR","operatorPublicName":"A2B Bus and Coach","vosaPsvLicenseName":"","opId":"138245","pubNmId":"96067","nocCdQual":"","changeDate":"","changeAgent":"","changeComment":"","dateCeased":"","dataOwner":"","mode":"bus","dataSource":"bods"},{"id":50,"nocCode":"A2BR","operatorPublicName":"D2B Bus and Coach","vosaPsvLicenseName":"","opId":"138245","pubNmId":"96067","nocCdQual":"","changeDate":"","changeAgent":"","changeComment":"","dateCeased":"","dataOwner":"","mode":"bus","dataSource":"tnds"}]
    ...
    def test_display_with_sort_by_name(self, mrequests, client_factory):
        ...
        assert response.context_data["view"].template_name == self.template_path
        assert len(response.context_data["object_list"]) == 2
        assert response.context_data["object_list"][0]['operatorPublicName'] == "D2B Bus and Coach"
