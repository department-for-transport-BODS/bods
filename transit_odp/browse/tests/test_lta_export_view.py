...
from transit_odp.browse.lta_column_headers import header_accessor_data_line_level
from transit_odp.browse.views.local_authority import LTALineLevelCSV
...
# To be uncommented once feature flag is removed for AVL changes
...
#     services_list_1.append(
#         ServiceModelFactory(
#             licence=otc_lic2, registration_number=registration_number2
#         )
#     )
#     services_list_1.append(
#         ServiceModelFactory(
#             licence=otc_lic2, registration_number=registration_number3
#         )
#     )
#     services_list_1.append(
#         ServiceModelFactory(
#             licence=otc_lic2, registration_number=registration_number6
#         )
#     )
...
#         ServiceModelFactory(
#             licence=otc_lic3, registration_number=registration_number5
#         )
#     )
...
#     lta_codes_csv = LTALineLevelCSV([local_authority_1, local_authority_2])
#     queryset = lta_codes_csv.get_queryset()
...
#         id="1",
#         name="first_LTA",
#         registration_numbers=services_list_1,
#         ui_lta=ui_lta,
#     )
...
#     assert (
#         csv_output["row0"][5] == '"Organisation not yet created"'
#     )  # Operator Name
...
#     lta_codes_csv = LTALineLevelCSV([local_authority])
#     csv_string = lta_codes_csv.to_string()
#     csv_output = get_csv_output(csv_string, CSV_LINE_LEVEL_NUMBER_COLUMNS)
