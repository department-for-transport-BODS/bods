...
class ContactOperatorView(LoginRequiredMixin, SingleObjectMixin, FormView):
    template_name = "browse/operators/contact_operator.html"
    form_class = OperatorFeedbackForm
    model = Organisation
    ...
    def form_valid(self, form):
        ...
        publisher_name = self.object.name
        org_users = self.object.users.filter(account_type=OrgAdminType)
