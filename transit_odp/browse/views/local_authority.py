...
if is_avl_require_attention_active:
    ...
    from transit_odp.publish.requires_attention import get_txc_map_lta
...
if is_avl_require_attention_active:
            ...
            self._object_list.append(
                {
                    ...
                    and file_attribute.organisation_name,
                    ...
                    "revision_number": file_attribute
                    and file_attribute.revision_number,
    ...
    class LocalAuthorityExportView(View):
        ...
        def render_to_response(self):
            ...
            csv_filename = f"{updated_ui_lta_name}_detailed service code export detailed export.csv"
