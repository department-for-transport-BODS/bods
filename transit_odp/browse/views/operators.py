...
class OperatorLicenceDetailView(BaseDetailView):
...
class OperatorLicenceLineMetadataDetailView(BaseDetailView):
    template_name = "browse/operators/licence_line_details.html"
    model = Dataset
    slug_url_kwarg = "number"
    slug_field = "number"
