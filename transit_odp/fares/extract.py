    ...
    if is_fares_validator_active:
        ...
        def tariff_basis(self):
            try:
                ...
                tariff_basis_list = self.documents.get_multiple_attr_text_from_xpath(
                    path
                )
        ...
        def product_type(self):
            try:
                ...
                product_type_list = self.documents.get_multiple_attr_text_from_xpath(
                    path
                )
        ...
        def product_name(self):
            try:
                ...
                product_name_list = self.documents.get_multiple_attr_text_from_xpath(
                    path
                )
