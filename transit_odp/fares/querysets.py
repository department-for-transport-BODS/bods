...
class FaresNetexFileAttributesQuerySet(models.QuerySet):
    def get_active_published_files(self):
        ...
        """
        qs = self.filter(
            Q(fares_metadata_id__revision__is_published=True) & Q(fares_metadata_id__revision__status=FeedStatus.live.value)
    ...
    def add_published_date(self):
        ...
        """
        return self.annotate(last_updated_date=F("fares_metadata_id__revision__published_at"))

    def add_operator_id(self):
        """
        Add operator Id to result. Dataset organisation_id used as operator_id
        """
        return self.annotate(operator_id=F("fares_metadata_id__revision__dataset__organisation_id"))
    ...
    def add_organisation_name(self):
        ...
        return self.annotate(
            organisation_name=F("fares_metadata_id__revision__dataset__organisation__name")
        )
    ...
    def add_compliance_status(self):
        ...
        """
        count = Q(fares_metadata_id__revision__dataset__live_revision__fares_validation_result__count=0)
        return self.annotate(
