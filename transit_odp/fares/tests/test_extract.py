...
SAMPLE_FILES = [
    (
        "sample1.xml",
        {
            ...
            "fares_valid_to": ["2022-12-31", "2020-12-31"],
            "line_id": [["16"]],
            "line_name": [["16"]],
...
EXPECTED_METADATA_ZIP = {
    "schema_version": "1.1",
    "xml_file_name": ["sample1.xml", "sample2.xml"],
    "num_of_lines": 2,
    ...
    "fares_valid_from": ["2020-01-01", "2020-01-01"],
    "fares_valid_to": ["2022-12-31", "2020-12-31"],
    "line_id": [["16"], ["11"]],
    "line_name": [["16"], ["11"]],
    "national_operator_code": [["HCTY", "ATOC", "NR"], ["BLAC", "ATOC", "NR"]],
    "product_name": [["single Ticket - adult"], ["Single Ticket"]],
    "product_type": [[], []],
    "tariff_basis": [["zoneToZone"], ["zoneToZone"]],
    "user_type": [["adult"], []],
}
