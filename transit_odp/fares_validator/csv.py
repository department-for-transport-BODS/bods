...
FARES_DATA_COLUMN_MAP = OrderedDict(
    {
        "fares_metadata_id": Column(
            "Dataset ID",
            "The internal BODS generated ID of the operator/"
            "publisher providing data on BODS.",
        ),
        ...
        "valid_to": Column(
            "Valid to",
            "The operating period end date as extracted from the files provided"
            " by the operator/publisher to BODS.",
        ),
        "line_id": Column(
            "Line ids",
            "The Line id(s) as extracted from the files provided by the operator/"
            "publisher to BODS.",
        ),
        "line_name": Column(
            "Line Name",
            "The line name(s) as extracted from the files provided by the operator/"
            "publisher to BODS.",
        ),
        "atco_area": Column(
            "ATCO Area",
            "The ATCO Area (s) extracted from the ScheduledStopPoints in the files "
