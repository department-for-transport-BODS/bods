...
def test_bulk_archive_creates_2_files():
    """Tests upload_bulk_data_archive creates 2 archive files - Timetable and Fares"""
    # Test
...
def test_bulk_data_archive_not_adding_dataset_with_inactive_org():
    ...
    DatasetFactory.create_batch(
        5, live_revision__upload_file__data=b"Test data1", organisation=org1
    )
